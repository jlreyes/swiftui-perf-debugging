---
name: scroll-animation-jank
description: Diagnoses scroll and animation jank in SwiftUI macOS/iOS apps using a frame-first workflow. Covers interaction windowing, severity buckets, cascade analysis, per-frame attribution, root cause clustering, and a final report template. Companion to the main Claude Instruments skill (SKILL.md).
---

# SwiftUI Scroll & Animation Jank Diagnosis

This is a use-case-specific companion to [SKILL.md](SKILL.md). Use it when investigating **scroll lag**, **animation stutter**, and **frame drops** in SwiftUI apps.
...
- General Instruments → DuckDB workflow: see [SKILL.md](SKILL.md)
